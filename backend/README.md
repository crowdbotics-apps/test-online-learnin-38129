...
## Project Structure
    ...
    ├── test_online_learnin_38129  # Django project configurations
...
1. Clone this repo and `cd test_online_learnin_38129`
...
2. Clone this repo and `cd test_online_learnin_38129`
